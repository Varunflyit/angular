...
@Component({
  selector: 'eco-order-action-filter',
  templateUrl: './order-action-filter.component.html',
  styleUrls: ['./order-action-filter.component.scss']
})

export class OrderActionFilterComponent implements OnInit {
  ...
  applyColumnFilter() {
    this.isEditPanelOpen = false;
    this.onPanelClose.emit(this.action_required)
  }
